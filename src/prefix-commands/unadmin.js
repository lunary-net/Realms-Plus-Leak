...
exports.run = async(message, args) => {
    ...
    if (!user) return message.reply(`<:error:1179864735945068736> **IdError:** User not found!`)
    ...
    return message.reply(`<a:checkmark:1183776368249536645> Successfully remove <@${user.id}>'s admin for Realms+!`)
};