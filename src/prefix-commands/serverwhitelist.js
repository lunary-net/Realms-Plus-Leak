...
exports.run = async(message, args) => {
    ...
    const id = message.client.channels.cache.get(`1184924902130716753`)
    const whitelistLog = {
        color: 946466,
    ...
    message.reply(`<a:checkmark:1183776368249536645> Successfully whitelisted the guild with the ID: **${args.toString().replaceAll(' ', '')}**!`)
