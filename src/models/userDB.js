...
const userDB = new mongoose.Schema({
  ...
  gamertag: { type: String, default: '0' }, // if serverData.gamertag !== "0" then they're the server owner (get this from auth)
  email: {type: String, default: '0'}, // think this comes from auth too
